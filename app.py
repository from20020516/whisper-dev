...
options = whisper.DecodingOptions(
    fp16=True, # `False` when RuntimeError: "slow_conv2d_cpu" not implemented for 'Half'
    language="Japanese",
)
...
# start recording
with sc.get_microphone(id=str(sc.default_microphone().name), include_loopback=False).recorder(samplerate=SAMPLE_RATE, channels=1) as mic:
